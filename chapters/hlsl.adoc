...
For a detailed, side-by-side comparison of GLSL and HLSL syntax, data types, resource binding, built-ins vs. semantics, and more, see xref:{chapters}high_level_shader_language_comparison.adoc[High Level Shader Language Comparison].
