...
This extension adds more information to query about each implementation. The link:https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#VkDriverId[VkDriverId] will be a registered vendor's ID for the implementation. The link:https://www.khronos.org/registry/vulkan/specs/1.2-extensions/html/vkspec.html#VkConformanceVersion[VkConformanceVersion] displays which version of xref:../vulkan_cts.adoc[the Vulkan Conformance Test Suite] the implementation passed.
