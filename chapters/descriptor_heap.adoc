...
[NOTE]
====
Make sure to use property values like `bufferDescriptorSize` instead of `vkGetPhysicalDeviceDescriptorSizeEXT` here. The `vkGetPhysicalDeviceDescriptorSizeEXT` is only for when using the mappings.
====
