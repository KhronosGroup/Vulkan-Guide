...
**Note:** `BufferBlock` and `Uniform` would have been seen prior to xref:{chapters}extensions/shader_features.adoc#VK_KHR_storage_buffer_storage_class[VK_KHR_storage_buffer_storage_class]
