...
Vulkan offers two types of descriptors that allow adjusting the offset at bind time as link:https://www.khronos.org/registry/vulkan/specs/1.2/html/vkspec.html#descriptorsets-binding-dynamicoffsets[defined in the spec].
