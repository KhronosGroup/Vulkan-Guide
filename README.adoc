...
// include::{chapters}depth.adoc[]
  ...
  * `VK_EXT_depth_range_unrestricted`, `VK_EXT_depth_clip_enable`
...
== xref:{chapters}extensions/translation_layer_extensions.adoc[Translation Layer Extensions]
  ...
  * `VK_EXT_custom_border_color`, `VK_EXT_border_color_swizzle`, `VK_EXT_depth_clip_enable`, `VK_EXT_provoking_vertex`, `VK_EXT_transform_feedback`, `VK_EXT_image_view_min_lod`
