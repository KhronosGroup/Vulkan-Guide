...
Khronos のlink:https://github.com/KhronosGroup/Vulkan-Samples/tree/master/samples/performance/swapchain_images[サンプルとチュートリアル]では、スワップチェーンを作成する際や表示モードを選択する際に考慮すべきさまざまな点を説明しています。
